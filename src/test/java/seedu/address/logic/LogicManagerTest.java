...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonTodoListStorage addressBookStorage =
                new JsonTodoListStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        // Setup LogicManager with JsonTodoListIoExceptionThrowingStub
        JsonTodoListStorage addressBookStorage =
